...
export default function HomePage() {
  ...
  // Change URL (move to another page)
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <span style={iconStyle} onClick={copyShareLink} title="Copy URL">
              🔗
            </span>
            <button style={removeAdBtn}>Remove Ads</button>
          </div>
        </div>
          ...
          <div style={modalOverlay}>
            <div style={modalBox}>
              ...
              <div style={{ display: "flex", gap: "8px", marginTop: "10px" }}>
                <button style={miniButton}>Lock</button>
                <button
                  style={miniButton}
        ...
        {showChangeUrlModal && (
          <div style={modalOverlay}>
            <div style={modalBox}>
              ...
              />
              <div style={{ display: "flex", gap: "8px", marginTop: "10px" }}>
                <button style={miniButton} onClick={handleChangeUrl}>
                  Change
                </button>
                <button
                  style={miniButton}
                  onClick={() => setShowChangeUrlModal(false)}
                >
                  X
                </button>
              </div>
